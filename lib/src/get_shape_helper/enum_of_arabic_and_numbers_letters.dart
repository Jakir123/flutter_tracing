        ...
        if (_isArabicCharacter(letters)) {
          tracingDataList
              .addAll(_getTracingDataArabic(
                ...
                letterBoxSize: char.charViewSize
              ).map((e) => e.copyWith(
...
// Helper functions to detect the type of letter
  ...
  List<TraceModel> _getTracingDataArabic({required String letter, ArabicCharacterForm? characterForm, Size? letterBoxSize}) {
    ...
    final viewSize = letterBoxSize ?? const Size(200, 200);
      ...
      switch (form) {
        ...
        case ArabicCharacterForm.end:
          return [
            TraceModel(
              letterViewSize: viewSize,
                positionIndexPath: const Size(-70, -120),
                positionDottedPath: const Size(16, -5),
                scaledottedPath: .9,
                scaleIndexPath: 1.05,
                strokeWidth: 60,
                ...
                letterPath: ArabicShapePaths.alefEnd,
                strokeIndex: 1,
                pointsJsonFile: ShapePointsManger.alefEndShape,
                innerPaintColor: AppColorPhonetics.lightBlueColor5,
                outerPaintColor: AppColorPhonetics.lightBlueColor5),
          ];
    ...
    // Zal - ذ
    if (letter == ArabicLetter.zal.tracingChar) {
      switch (form) {
        case ArabicCharacterForm.isolated:
          return [
            TraceModel(
        ...
        case ArabicCharacterForm.end:
          return [
            TraceModel(
                ...
                letterPath: ArabicShapePaths.aynEndShape,
                strokeIndex: 1,
                pointsJsonFile: ShapePointsManger.einEndShape,
                innerPaintColor: AppColorPhonetics.lightBlueColor5,
                outerPaintColor: AppColorPhonetics.lightBlueColor5),
          ];
        ...
        case ArabicCharacterForm.end:
          return [
            TraceModel(
                ...
                letterPath: ArabicShapePaths.ghenEndShape,
                strokeIndex: 1,
                pointsJsonFile: ShapePointsManger.ghenEndShape,
                innerPaintColor: AppColorPhonetics.lightBlueColor5,
                outerPaintColor: AppColorPhonetics.lightBlueColor5),
          ];
          ...
          return [
            TraceModel(
              letterViewSize: viewSize,
                ...
                letterPath: ArabicShapePaths.faEndShape,
                strokeIndex: 1,
                pointsJsonFile: ShapePointsManger.faEndShape,
                innerPaintColor: AppColorPhonetics.lightBlueColor5,
                outerPaintColor: AppColorPhonetics.lightBlueColor5),
          ];
      ...
      switch (form) {
        ...
        case ArabicCharacterForm.end:
          return [
            TraceModel(
              letterViewSize: viewSize,
                positionIndexPath: const Size(-4, 10),
                positionDottedPath: const Size(0, -5),
                scaledottedPath: .88,
                scaleIndexPath: 1.1,
                indexPathPaintStyle: PaintingStyle.stroke,
                ...
                letterPath: ArabicShapePaths.kafEndShape,
                strokeWidth: 40,
                strokeIndex: 1,
                pointsJsonFile: ShapePointsManger.kafEndShape,
                innerPaintColor: AppColorPhonetics.lightBlueColor5,
                outerPaintColor: AppColorPhonetics.lightBlueColor5),
          ];
        ...
        case ArabicCharacterForm.middle:
          return [
            TraceModel(
                ...
                letterPath: ArabicShapePaths.kafMiddleShape,
                pointsJsonFile: ShapePointsManger.kafMiddleShape,
                strokeIndex: 1,
                innerPaintColor: AppColorPhonetics.lightBlueColor5,
                outerPaintColor: AppColorPhonetics.lightBlueColor5),
          ];
